...
Entity.prototype.rotateAndCache = function (image, angle) {
    ...
    var widthAdjust = angle / (Math.PI * 2);
    var width = (image.width * image.height) / image.width;
    var heightAdjust = angle / (Math.PI * 2);
    var height =(image.height * image.width) / image.height;
